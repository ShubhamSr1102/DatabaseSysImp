...
TEST(GTEST_1, SortedFileTestForNationTable) {
	...
	FILE *dbFile = fopen("../../data/tpch-1gb/nation.tbl", "r");
...
TEST(GTEST_2, SortedFileTestForCustomerTable) {
	...
	FILE *dbFile = fopen("../../data/tpch-1gb/customer.tbl", "r");
...
TEST(GTEST_3, SortedFileTestForPartTable) {
	...
	FILE *dbFile = fopen("../../data/tpch-1gb/part.tbl", "r");
...
TEST(GTEST_4, SortedFileTestForLineItemTable) {
	...
	FILE *dbFile = fopen("../../data/tpch-1gb/lineitem.tbl", "r");
